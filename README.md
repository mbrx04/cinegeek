...
<img src="assets/logo.png" alt="CineGeek Cover" width="600" style="border-radius: 10px; box-shadow: 0px 4px 10px rgba(0,0,0,0.2);" />
...
> **Scenario d'uso:** Quando l'utente è al cinema e le luci si abbassano, CineGeek invia una **Notifica Intelligente** suggerendo la modalità silenziosa. A fine film, una seconda notifica invita a votare subito la pellicola appena vista.
